...
#_C.MODEL.PRETRAIN = "/data/anuradha/WACV25_Reviews/IR/From_Sindhu/Experiments-SOP-Training-Data/128-dim/MSimLoss/output_anu_ms_loss/run_4/best_model.pth" 

_C.MODEL.PRETRAINED_PATH = MODEL_PATH
...
# Loss
_C.LOSSES = CN()
_C.LOSSES.NAME = 'ms_loss' # anu_ms_loss, anu_triplet_loss, margin_loss, ms_loss, triplet_loss, fastap_loss, anu_fastap_loss, npairs_loss
_C.LOSSES.REG_LAMBDA = 1.0
# ms loss
...
# anu ms loss
_C.LOSSES.ANU_MULTI_SIMILARITY_LOSS = CN()
_C.LOSSES.ANU_MULTI_SIMILARITY_LOSS.SCALE_POS = 2.0
_C.LOSSES.ANU_MULTI_SIMILARITY_LOSS.SCALE_NEG = 40.0
_C.LOSSES.ANU_MULTI_SIMILARITY_LOSS.HARD_MINING = True
_C.LOSSES.TYPE = 'all'
# triplet loss
_C.LOSSES.TRIPLET_LOSS = CN()

# anu triplet loss
_C.LOSSES.ANU_TRIPLET_LOSS = CN()
...
## Cars-196 training dataset
#_C.DATA.TRAIN_IMG_SOURCE = 'resource/datasets/cars196/train.txt'
#_C.DATA.TEST_IMG_SOURCE = 'resource/datasets/cars196/test.txt'

## SOP dataset
_C.DATA.TRAIN_IMG_SOURCE = 'resource/datasets/Stanford_Online_Products/Ebay_train_upd.txt'
_C.DATA.TEST_IMG_SOURCE = 'resource/datasets/Stanford_Online_Products/Ebay_test_upd.txt'

_C.DATA.TRAIN_BATCHSIZE = 70
_C.DATA.TEST_BATCHSIZE = 256
_C.DATA.NUM_WORKERS = 30
