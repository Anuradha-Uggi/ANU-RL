...
CUDA_VISIBLE_DEVICES=0 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR output_anu_ms_loss/Hardest/run_2 \
                                              LOSSES.NAME anu_ms_loss \
                                              LOSSES.TYPE hardest \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/CUB_200_2011/train.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/CUB_200_2011/test.txt' \
...
CUDA_VISIBLE_DEVICES=0 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR output_anu_ms_loss/Hardest/run_3 \
                                              LOSSES.NAME anu_ms_loss \
                                              LOSSES.TYPE hardest \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/CUB_200_2011/train.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/CUB_200_2011/test.txt' \
...
# ANU MS Loss (Ours): ALL
CUDA_VISIBLE_DEVICES=0 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR output_anu_ms_loss/ALL/run_1 \
                                              LOSSES.NAME anu_ms_loss \
                                              LOSSES.TYPE all \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/CUB_200_2011/train.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/CUB_200_2011/test.txt' \
...
CUDA_VISIBLE_DEVICES=0 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR output_anu_ms_loss/ALL/run_2 \
                                              LOSSES.NAME anu_ms_loss \
                                              LOSSES.TYPE all \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/CUB_200_2011/train.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/CUB_200_2011/test.txt' \
...
CUDA_VISIBLE_DEVICES=0 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR output_anu_ms_loss/ALL/run_3 \
                                              LOSSES.NAME anu_ms_loss \
                                              LOSSES.TYPE all \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/CUB_200_2011/train.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/CUB_200_2011/test.txt' \
...
# ANU MS Loss (Ours): Easiest
CUDA_VISIBLE_DEVICES=0 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR output_anu_ms_loss/Easiest/run_1 \
                                              LOSSES.NAME anu_ms_loss \
                                              LOSSES.TYPE easiest \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/CUB_200_2011/train.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/CUB_200_2011/test.txt' \
...
CUDA_VISIBLE_DEVICES=0 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR output_anu_ms_loss/Easiest/run_2 \
                                              LOSSES.NAME anu_ms_loss \
                                              LOSSES.TYPE easiest \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/CUB_200_2011/train.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/CUB_200_2011/test.txt' \
...
CUDA_VISIBLE_DEVICES=0 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR output_anu_ms_loss/Easiest/run_3 \
                                              LOSSES.NAME anu_ms_loss \
                                              LOSSES.TYPE easiest \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/CUB_200_2011/train.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/CUB_200_2011/test.txt' \
