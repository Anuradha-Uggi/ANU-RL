...
# tripelt Loss (BL)
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_triplet_loss_bl/run_1 \
...
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_triplet_loss_bl/run_2 \
                                              LOSSES.NAME triplet_loss \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/train_labels.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/test_labels.txt' \
                                              MODEL.HEAD.DIM 512 \
...
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_triplet_loss_bl/run_3 \
                                              LOSSES.NAME triplet_loss \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/train_labels.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/test_labels.txt' \
                                              MODEL.HEAD.DIM 512 \
...
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_triplet_loss_bl/run_4 \
                                              LOSSES.NAME triplet_loss \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/train_labels.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/test_labels.txt' \
                                              MODEL.HEAD.DIM 512 \
...
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_triplet_loss_bl/run_5 \
                                              LOSSES.NAME triplet_loss \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/train_labels.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/test_labels.txt' \
                                              MODEL.HEAD.DIM 512 \
...
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_anu_triplet_loss/run_1 \
...
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_anu_triplet_loss/run_2 \
                                              LOSSES.NAME anu_triplet_loss \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/train_labels.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/test_labels.txt' \
                                              MODEL.HEAD.DIM 512 \
...
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_anu_triplet_loss/run_3 \
                                              LOSSES.NAME anu_triplet_loss \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/train_labels.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/test_labels.txt' \
                                              MODEL.HEAD.DIM 512 \
...
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_anu_triplet_loss/run_4 \
                                              LOSSES.NAME anu_triplet_loss \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/train_labels.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/test_labels.txt' \
                                              MODEL.HEAD.DIM 512 \
...
CUDA_VISIBLE_DEVICES=1 python tools/main.py --cfg configs/example.yaml \
                                              SAVE_DIR inshop_anu_triplet_loss/run_5 \
                                              LOSSES.NAME anu_triplet_loss \
                                              DATA.TRAIN_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/train_labels.txt' \
                                              DATA.TEST_IMG_SOURCE 'resource/datasets/deepfashion-inshop-clothes-retrieval/test_labels.txt' \
                                              MODEL.HEAD.DIM 512 \
