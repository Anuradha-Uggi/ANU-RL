...
from models.aggregators import netvlad, supervlad
...
def get_aggregator(agg_arch='ConvAP', agg_config={}, init_path=True):
    ...
    if 'cosplace' in agg_arch.lower():
        ...
        return net_vlad#netvlad.initialize_weights(init_path, net_vlad)
        #return net_vlad
        
    elif 'supervlad' in agg_arch.lower(): 
        assert 'num_clusters' in agg_config
        assert 'dim' in agg_config
        super_vlad = supervlad.SuperVLAD(**agg_config)
        return super_vlad  
