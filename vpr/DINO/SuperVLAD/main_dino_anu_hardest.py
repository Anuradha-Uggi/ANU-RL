...
if __name__ == '__main__':
    ...
    model = VPRModel(
        ...
        #---- Train hyperparameters
        lr=0.0001, # 0.0002 for adam, 0.05 or sgd (needs to change according to batch size)
    ...
    trainer = pl.Trainer(
        ...
        default_root_dir=f'./ANU-Hardest-Pairs/{model.encoder_arch}', # Tensorflow can be used to viz 
