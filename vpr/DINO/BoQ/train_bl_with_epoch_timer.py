...
class EpochTimer(Callback):
    ...
    def on_train_epoch_end(self, trainer, pl_module):
        ...
        print(f"\nEpoch {trainer.current_epoch} training time: {epoch_time:.2f}s | Avg: {avg:.2f}s")
...
class HyperParams:
    def __init__(self):
        ...
        self.gsv_cities_path: str = '/home/anuradha/MyResearch@Sindhu/DataSets/Gsv-Cities/'    # path to gsv-cities in OpenVPRLab
        ...
        self.val_sets: dict = {
            "msls-val":     "/home/anuradha/MyResearch@Sindhu/WACV-ANUs-RL/Multi-Sim/Triplet-Miner/BoQ/data/val/msls-val",              # path to the msls-val dataset
            "pitts30k-val": "/home/anuradha/MyResearch@Sindhu/WACV-ANUs-RL/Multi-Sim/Triplet-Miner/BoQ/data/val/pitts30k-val",          # path to the pitts30k-val dataset
        }
...
def train(hparams, dev_mode=False):
    ...
    callback_list = [checkpointing, epoch_timer]
    if not hparams.silent:
