...
from src.model_anu_hardest import BoQModel
from src.dataloaders.datamodule import VPRDataModule

class HyperParams:
    def __init__(self):
        ## Backbone config:
        self.backbone_name: str = "resnet50"    # resnet18, resnet50, dinov2_vits14, dinov2_vitl14
        self.unfreeze_n_blocks: int = 1              # number of blocks to unfreeze in the backbone
        ...
        self.gsv_cities_path: str = '/home/anuradha/A-MyResearch-Sindhu/DataSets/Gsv-Cities/'    # path to gsv-cities in OpenVPRLab
        ...
        self.val_sets: dict = {
            "msls-val":     "/home/anuradha/A-MyResearch-Sindhu/WACV-ANUs-RL/Multi-Sim/Triplet-Miner/BoQ/data/val/msls-val",              # path to the msls-val dataset
            "pitts30k-val": "/home/anuradha/A-MyResearch-Sindhu/WACV-ANUs-RL/Multi-Sim/Triplet-Miner/BoQ/data/val/pitts30k-val",          # path to the pitts30k-val dataset
        }
        ...
        #self.seed: int = 2024                # seed 1. random seed for reproducibility
        self.seed: int = 2025                # seed 2
        #self.seed: int = 2026                # seed 3
...
def train(hparams, dev_mode=False):
    ...
    tensorboard_logger = TensorBoardLogger(
        save_dir=f"./ANU-Hardest-Pairs/TMLR-Rev/seed-2/",
