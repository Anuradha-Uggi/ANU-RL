...
####### GardensPointWalking left #####
   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/GardensPointWalking_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/GardensPointWalking_db_left_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/gardens_left/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --data_name='gardens_left' --inp_dim=$dataS
 
   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/GardensPointWalking_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/GardensPointWalking_db_left_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/gardens_left/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/gardens_left/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/gardens_left/ --data_name='gardens_left' --inp_dim=$dataS


####### SPEDTest #####
   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/sped_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/sped_db_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/sped/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --data_name='sped' --inp_dim=$dataS
 
   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/sped_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/sped_db_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/sped/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/sped/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/sped/ --data_name='sped' --inp_dim=$dataS

########################## Additional datasets ####################################

######## St_Lucia

   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/st_lucia_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/st_lucia_db_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/st_lucia/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --data_name='st_lucia' --inp_dim=$dataS
 
   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/st_lucia_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/st_lucia_db_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/st_lucia/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/st_lucia/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/st_lucia/ --data_name='st_lucia' --inp_dim=$dataS


####### Eynsham
   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/eynsham_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/eynsham_db_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/eynsham/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --data_name='eynsham' --inp_dim=$dataS
 
   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/eynsham_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/eynsham_db_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/eynsham/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/eynsham/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/eynsham/ --data_name='eynsham' --inp_dim=$dataS


######## SVOX
   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --inp_dim=$dataS 
 
   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/ --data_name='svox' --inp_dim=$dataS


########## SVOX Night

   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_night_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/night/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --data_name='svoxvar' --inp_dim=$dataS

   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_night_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/night/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/night/ --data_name='svoxvar' --inp_dim=$dataS

############# SVOX Overcast
   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_overcast_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/overcast/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --data_name='svoxvar' --inp_dim=$dataS

   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_overcast_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/overcast/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/overcast/ --data_name='svoxvar' --inp_dim=$dataS

############ SVOX Rain
   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_rain_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/rain/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --data_name='svoxvar' --inp_dim=$dataS

   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_rain_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/rain/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/rain/ --data_name='svoxvar' --inp_dim=$dataS

############ SVOX Snow
   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_snow_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/snow/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --data_name='svoxvar' --inp_dim=$dataS


   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_snow_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/snow/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/snow/ --data_name='svoxvar' --inp_dim=$dataS

############ SVOX Sun
   #python feature_extract_new.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_sun_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --output_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/sun/ --model_path="./../ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt" --data_name='svoxvar' --inp_dim=$dataS


   python feature_match.py --query_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_qry_sun_names.txt --index_file_path=/data/anuradha/Anus-PhD/Used-Datasets-WACV-25/dataset_names/svox_db_names.txt --query_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/sun/ --index_input_features_dir=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/ --result_save_folder=./ANU-Hardest-Pairs/TMLR-Rev/$dataSx$dataS-dim/svox/sun/ --data_name='svoxvar' --inp_dim=$dataS  #''' 
