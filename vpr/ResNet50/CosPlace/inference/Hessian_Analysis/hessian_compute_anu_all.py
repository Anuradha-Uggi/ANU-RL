...
def loss_surface(model, top_eigenvectors, images, labels):
    ...
    #plot_3d_heatmap(X, Y, Z, 'Anu_All_CosPlace_60.png')
    plot_2d_contour(X, Y, Z, 'ANU_ALL_CosPlace_contour.png')
...
def main():
    ...
    parser.add_argument('--anu_all_model_path', type=str, default='/data/anuradha/Anus-PhD/WACV25_Reviews/VPR/WACV25/Multi-Sim/CosPlace/ANU-All-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(34)_step(21910)_R1[0.8923]_R5[0.9460].ckpt')
