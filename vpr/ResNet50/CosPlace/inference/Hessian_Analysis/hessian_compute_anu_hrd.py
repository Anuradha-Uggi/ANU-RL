...
def loss_surface(model, top_eigenvectors, images, labels):
    ...
    Z = loss_surface
    #plot_3d_heatmap(X, Y, Z, 'Anu_Hrd_CosPlace_60.png')
    plot_2d_contour(X, Y, Z, 'ANU_Hrd_CosPlace_contour.png')
...
def main():
    ...
    parser.add_argument('--anu_all_model_path', type=str, default='/data/anuradha/Anus-PhD/WACV25_Reviews/VPR/WACV25/Multi-Sim/CosPlace/ANU-Hardest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(36)_step(23162)_R1[0.8952]_R5[0.9440].ckpt')
