...
if __name__ == '__main__':
    pl.utilities.seed.seed_everything(seed=190223, workers=True) # seed1
    #pl.utilities.seed.seed_everything(seed=190224, workers=True) # seed2
    #pl.utilities.seed.seed_everything(seed=190225, workers=True) # seed3
    ...
    trainer = pl.Trainer(
        ...
        default_root_dir=f'./ANU-Easiest-Pairs/TMLR-Rev/{model.encoder_arch}', # Tensorflow can be used to viz 
