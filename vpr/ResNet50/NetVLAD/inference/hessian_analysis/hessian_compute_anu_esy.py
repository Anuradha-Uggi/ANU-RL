...
def loss_surface(model, top_eigenvectors, images, labels):
    ...
    #plot_3d_heatmap(X, Y, Z, 'Anu_Esy_r2f.png')
    plot_2d_contour(X, Y, Z, 'ANU_Esy_nv_contour.png')
...
def main():
    ...
    parser.add_argument('--anu_all_model_path', type=str, default='/data/anuradha/Anus-PhD/WACV25_Reviews/VPR/WACV25/Multi-Sim/NetVLAD/MSim-Miner/ANU-Easiest-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(39)_step(25040)_R1[0.8834]_R5[0.9403].ckpt')
