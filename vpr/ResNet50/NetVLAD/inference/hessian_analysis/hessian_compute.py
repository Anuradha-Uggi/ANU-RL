...
def loss_surface(model, top_eigenvectors, images, labels):
    ...
    Z = loss_surface
    #3D Heatmap
    #plot_3d_heatmap(X, Y, Z, 'BL_nv_3d.png')
    plot_2d_contour(X, Y, Z, 'BL_nv_contour.png')
...
def main():
    ...
    parser.add_argument('--bl_model_path', type=str, default='/data/anuradha/Anus-PhD/WACV25_Reviews/VPR/WACV25/Multi-Sim/NetVLAD/MSim-Miner/LOGS-MSim-BL/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(39)_step(25040)_R1[0.8999]_R5[0.9494].ckpt')
