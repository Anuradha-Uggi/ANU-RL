...
def loss_surface(model, top_eigenvectors, images, labels):
    ...
    #plot_3d_heatmap(X, Y, Z, 'Anu_All_r2f_3d.png')
    plot_2d_contour(X, Y, Z, 'ANU_ALL_nv_contour.png')
...
def main():
    ...
    parser.add_argument('--anu_all_model_path', type=str, default='/data/anuradha/Anus-PhD/WACV25_Reviews/VPR/WACV25/Multi-Sim/NetVLAD/MSim-Miner/ANU-All-Pairs/resnet50/lightning_logs/version_0/checkpoints/resnet50_epoch(17)_step(11268)_R1[0.8986]_R5[0.9462].ckpt')
