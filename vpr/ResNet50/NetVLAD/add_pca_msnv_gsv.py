...
class VPRModel(pl.LightningModule):
    def __init__(self,
        ...
        self.aggregator = helper.get_aggregator(self.agg_arch, self.agg_config, self.init_path)
...
def Model(opt, config, checkpoint, device):
    model = VPRModel(
           ...
           layers_to_crop=[4],         
           agg_arch='NetVLAD',
           agg_config={'num_clusters' : opt.num_clusters_pool2,
                       'dim' : 1024,
                       'vladv2' : opt.vladv2}, )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume_path', type=str, default='./LOGS-BL/resnet50/lightning_logs/version_0/checkpoints/model.ckpt',
